...
contract EuphoriaClub is ERC721Enumerable, Ownable {
    ...
    string public baseTokenURI = "https://nft-collection-api-test.herokuapp.com/";
    ...
    constructor () ERC721 ("Euphoria Club", "EUPH") {
        price = initial_price;
    }
